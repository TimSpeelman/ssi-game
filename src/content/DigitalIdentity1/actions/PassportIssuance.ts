...
export const Schema = BaseSchema.extend({
    ...
    props: {
        ...
        dateOfBirth: new StringProp({ title: translations.dateOfBirth, required: true }),
        placeOfIssuance: new StringProp({ title: translations.placeOfIssuance, required: true }),
        placeOfBirth: new StringProp({ title: translations.placeOfBirth, required: true }),
        dateOfIssuance: new StringProp({ title: translations.dateOfIssuance, required: true }),
        dateOfExpiry: new StringProp({ title: translations.dateOfExpiry, required: true }),
        height: new StringProp({ title: translations.height, required: true }),
        documentNumber: new StringProp({ title: translations.documentNumber, required: true }),
        nationality: new StringProp({ title: translations.nationality, required: true }),
    },
});
